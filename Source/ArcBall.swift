...
class ArcBall {
    ...
    func initialize(_ newWidth:Float, _ newHeight:Float) {
        ...
        startPosition = float3x3(
            [1.014003e+00, 2.120235e-02, 5.285045e-02],
            [-1.977752e-02, 1.015271e+00, -2.496732e-02],
            [-5.405553e-02, 2.418543e-02, 9.984533e-01])
        
        aData.endPosition = startPosition
        aData.transformMatrix = arcBall.copyMatrixToQuaternion(aData.transformMatrix,startPosition)
    }
